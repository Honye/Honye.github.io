(function() {
	var h = {}, mt = {}, c = {
			id: "fb600209926cf4821e2bd66a9bed7583",
			dm: ["jsgame.net"],
		...
		return function(d) {
			switch (typeof d) {
				...
				default:
					...
					e = mt.m.stringify;
					for (n in d)
						if (Object.prototype.hasOwnProperty.call(d, n)) switch (m =
							d[n], typeof m) {
							case "undefined":
							case "unknown":
							case "function":
	...
	(function() {
		...
		function f(a) {
			...
			if (a in m) r = a;
				...
				for (var q = ["webkit", "ms", "moz", "o"], b = 0; b < q.length; b++) {
			...
			e = {
				...
				W: function() {
					if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
						...
						var a = window._hmt;
						if (a && a.length)
							for (var b = 0, f = a.length; b < f; b++) d.d(a[b],
				...
				X: function() {
					if (0 < e.n.length)
						for (var a = 0, b = e.n.length; a < b; a++) e.D(e.n[a]);
					e.n = s
				},
				D: function(a) {
					if (d.d(a, "Array")) {
				...
				_trackRTEvent: function(b) {
					...
					if (d.d(b, "Object")) {
						...
						if (900 >= l) f.call(this, b);
							...
							for (var l = Math.ceil(l / 900), r = "block|" + Math.round(Math.random() * n.q).toString(16) + "|" + l + "|", q = [], u = 0; u < l; u++) q.push(u), q.push(b.substring(900 * u, 900 * u + 900)), f.call(this, r + q.join("|")),
						q = []
					}
				},
		...
		a.prototype = {
			...
			A: function() {
				for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++)
					if (this.C(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
				return a
			},
			J: function() {
